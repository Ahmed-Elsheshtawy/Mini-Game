...
function PrimaryButton({children, onPress}){ // an implicitely provided prop called "children" that stores the children under the component (the tree of components under this component)
